...
var require_utilities = __commonJS({
  "node_modules/html-dom-parser/lib/client/utilities.js"(exports) {
    ...
    var domhandler = (init_dist2(), __toCommonJS(dist_exports));
    ...
    function getCaseSensitiveTagName(tagName) {
      return require_constants2.CASE_SENSITIVE_TAG_NAMES_MAP[tagName];
    }
...
var require_domparser = __commonJS({
  "node_modules/html-dom-parser/lib/client/domparser.js"(exports) {
    var require_utilities3 = require_utilities();
    var HTML = "html";
    var HEAD = "head";
    var BODY = "body";
    ...
    function domparser(html, trustedTypePolicy) {
      ...
      html = require_utilities3.escapeSpecialCharacters(html);
      const firstTagName = (_b = (_a = FIRST_TAG_REGEX.exec(html)) == null ? void 0 : _a[1]) == null ? void 0 : _b.toLowerCase();
      switch (firstTagName) {
        case HTML: {
          const doc = parseFromString(html);
          if (!require_utilities3.hasOpenTag(html, HEAD)) {
            const element = doc.querySelector(HEAD);
            (_c = element == null ? void 0 : element.parentNode) == null ? void 0 : _c.removeChild(element);
          }
          if (!require_utilities3.hasOpenTag(html, BODY)) {
            const element = doc.querySelector(BODY);
            (_d = element == null ? void 0 : element.parentNode) == null ? void 0 : _d.removeChild(element);
          }
        ...
        case BODY: {
          ...
          if (require_utilities3.hasOpenTag(html, BODY) && require_utilities3.hasOpenTag(html, HEAD)) return ((_e = elements[0].parentNode) == null ? void 0 : _e.childNodes) ?? createNodeList();
          return elements;
        }
        default:
          if (parseFromTemplate) return parseFromTemplate(html, trustedTypePolicy);
          return ((_f = parseFromDocument(html, BODY, trustedTypePolicy).querySelector(BODY)) == null ? void 0 : _f.childNodes) ?? createNodeList();
      }
    }
...
var require_html_to_dom = __commonJS({
  "node_modules/html-dom-parser/lib/client/html-to-dom.js"(exports) {
    ...
    var require_utilities3 = require_utilities();
    var require_domparser2 = require_domparser();
    ...
    function HTMLDOMParser(html, options) {
      ...
      return require_utilities3.formatDOM(require_domparser2.default(html, options == null ? void 0 : options.trustedTypePolicy), null, directive);
    }
...
var require_cjs2 = __commonJS({
  "node_modules/style-to-object/cjs/index.js"(exports, module) {
    ...
    var inline_style_parser = require_cjs();
    inline_style_parser = __toESM2(inline_style_parser);
